...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with VISO Group for premium security architecture consulting." },
    ],
  }),
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <p className="text-lg text-foreground/70 mb-12 max-w-lg leading-relaxed">
                Connect with our lead architects and security consultants to discuss how we can secure your critical infrastructure and future-proof your assets.
              </p>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/60 text-sm leading-relaxed">Riyadh, Kingdom of Saudi Arabia<br/>Also operating in Khobar, Jubail, Jeddah and Yanbu</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-surface/50 backdrop-blur-xl border border-foreground/10 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
                ...
                <h2 className="font-display text-3xl font-bold mb-8 relative z-10">Send a Message</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="company" className="text-xs font-bold tracking-widest uppercase opacity-70">Company (Optional)</label>
                    <input 
                      id="company"
                      type="text" 
