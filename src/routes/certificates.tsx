...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative flex h-[80vh] items-center justify-center overflow-hidden bg-background">
      ...
      >
        <div className="absolute inset-0 bg-[url('https://res.cloudinary.com/dcefror3c/image/upload/v1781695184/images_1_s7wzhb.jpg')] bg-cover bg-center opacity-10 mix-blend-screen" />
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 text-center px-4">
        <motion.div
          ...
          className="mb-4 font-mono text-[10px] tracking-[0.4em] text-[#00AEEF]"
        >
          ACCREDITATIONS & COMPLIANCE
        </motion.div>
        <h1 className="text-5xl font-light leading-tight tracking-tight text-foreground md:text-7xl">
          Official <span className="italic text-[#00AEEF]">Certificates</span>.
        </h1>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {certificatesData.map((item, i) => (
            <motion.div
              ...
              className="group relative flex flex-col overflow-hidden rounded-2xl border border-foreground/10 bg-surface/40 p-6 backdrop-blur-xl hover:border-[#00AEEF]/50 transition-colors"
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#00AEEF] to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
...
function Footer() {
  return (
    <footer className="relative bg-background py-20 border-t border-foreground/10 overflow-hidden">
      <div className="absolute inset-0 opacity-5 [background-image:radial-gradient(circle_at_center,#00AEEF_1px,transparent_1px)] [background-size:24px_24px]" />
      <div className="mx-auto max-w-6xl px-8 relative z-10 grid gap-12 md:grid-cols-3">
        <div>
          <h4 className="font-mono text-[10px] tracking-[0.3em] text-[#00AEEF] mb-6">HEADQUARTERS</h4>
        ...
        <div>
          <h4 className="font-mono text-[10px] tracking-[0.3em] text-[#00AEEF] mb-6">CONTACT US</h4>
          <ul className="space-y-3 text-sm text-foreground/70">
            <li>
              <a href="mailto:info@visogroup.com" className="hover:text-[#00AEEF] transition-colors">info@visogroup.com</a>
            </li>
            <li>
              <a href="mailto:translation@visogroup.com" className="hover:text-[#00AEEF] transition-colors">translation@visogroup.com</a>
            </li>
            <li className="pt-2">
              <a href="tel:+966543966637" className="font-mono text-[#00AEEF]">+966 543 966 637</a>
            </li>
          </ul>
        </div>
        <div>
          <h4 className="font-mono text-[10px] tracking-[0.3em] text-[#00AEEF] mb-6">LEGAL</h4>
          <ul className="space-y-3 text-sm text-foreground/70">
