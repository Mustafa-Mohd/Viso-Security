...
export function TopNav() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-[150] flex items-center justify-between px-6 md:px-12 py-2 md:py-3 backdrop-blur-md bg-background/80 border-b border-foreground/5 transition-all duration-500">
